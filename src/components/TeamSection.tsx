...
const TeamSection = () => {
  ...
  useEffect(() => {
    ...
    // Listen for storage changes to refresh team data when admin makes changes
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'cusehacks_team_members') {
        fetchTeamMembers()
      }
    }
    ...
    // Also listen for custom events from the same tab (since storage events don't fire on same tab)
