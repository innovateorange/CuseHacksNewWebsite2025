      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-white/80 text-lg">
            Join us for Syracuse University's Premier Hackathon on October 4-5th, 2025
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-6 text-center text-sm text-white/60">
            <p>
              ...
              <a href="mailto:info@cusehacks.com" className="text-primary-400 hover:text-primary-300">
                info@cusehacks.com
              </a>
            </p>
          </div>
